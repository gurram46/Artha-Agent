...
class EnhancedAngelOneService:
    ...
    def _initialize_apis(self):
        ...
        try:
            # Try to import SmartApi, but handle gracefully if not available
            try:
    ...
    def authenticate_market_api(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Market API authentication error: {e}")
            return False
    ...
    def authenticate_trading_api(self) -> bool:
        ...
        try:
            ...
            logger.error(f"❌ Trading API authentication error: {e}")
            return False
    ...
    def authenticate(self) -> bool:
        ...
        try:
            if not self.is_configured():
                logger.warning("Angel One API not properly configured")
                return False
    ...
    def get_live_price(self, symbol: str) -> float:
        ...
        try:
            ...
            if ltp_data['status'] and 'data' in ltp_data:
                ...
                logger.warning(f"Failed to get live price for {symbol}: {ltp_data.get('message', 'Unknown error')}")
                return self._get_estimated_price(symbol)
    ...
    def generate_investment_url(self, recommendations: List[Dict[str, Any]]) -> str:
        ...
        try:
            ...
            logger.error(f"Error generating Angel One URL: {e}")
            return self.web_url
    ...
    def _create_basket_url(self, basket_items: List[Dict[str, Any]]) -> str:
        ...
        try:
            ...
            logger.error(f"Error creating basket URL: {e}")
            return self.web_url
    ...
    def create_investment_button_data(self, recommendations: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error creating button data: {e}")
            return {
                'provider': 'angel_one',
