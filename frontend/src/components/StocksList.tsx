      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
        <div className="flex flex-col items-center justify-center space-y-4">
          ...
          <div className="text-center">
            <p className="text-slate-900 font-medium">Loading Real-Time Stock Data</p>
            <p className="text-sm text-slate-600 mt-1">Fetching live NSE prices...</p>
            <p className="text-xs text-slate-500 mt-2">Unlimited updates • No rate limits • Real-time data</p>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold text-slate-900 mb-2">Unable to Load Real-Time Stock Data</h3>
          <p className="text-red-600 mb-4">{error || 'NSE API is not responding'}</p>
    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      <div className="px-6 py-4 border-b border-slate-200">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-slate-900">Top Indian Stocks</h3>
            <p className="text-sm text-slate-600">Real-time market data across sectors</p>
          </div>
        ...
        <table className="w-full">
          <thead className="bg-slate-50">
            <tr>
              ...
              <th className="px-6 py-3 text-right text-xs font-medium text-slate-500 uppercase tracking-wider">Market Cap</th>
              <th className="px-6 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider">Day Range</th>
            </tr>
          </thead>
            ...
            {stocks.map((stock) => (
              ...
              >
                <td className="px-6 py-4">
                  <div>
                    <div className="text-sm font-medium text-blue-600 hover:text-blue-800">{stock.symbol}</div>
